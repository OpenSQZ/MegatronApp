...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Process benchmark files and generate Chrome trace.")
    parser.add_argument("--benchmark_dir", help="Directory containing benchmark files (required)")
    ...
    with open(f"{benchmark_dir}/{benchmark_dir.split("/")[-1]}-aggregated.json", 'w') as f:
