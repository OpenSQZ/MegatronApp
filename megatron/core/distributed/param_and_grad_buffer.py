...
class _ParamAndGradBucketGroup:
    ...
    def start_grad_sync(self):
        ...
        # print('?', dist.get_rank(), is_torch_min_version("1.13.0"), self.ddp_config.use_distributed_optimizer)
        for bucket in self.buckets:
            if self.ddp_config.use_distributed_optimizer:
                local_data_view = shard_buffer(
                ...
                # print('?', dist.get_rank(), communication_group)
                dist.all_reduce(
...
class _ParamAndGradBuffer:
    ...
    def __init__(
        ...
        print('initgradbuffer', data_parallel_group)
