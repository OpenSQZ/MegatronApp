...
from megatron_patch.model.llava.rotary_pos_embedding import RotaryEmbedding
from megatron_patch.model.llava.rotary_pos_embedding import apply_rotary_pos_emb as apply_llama2_rotary_pos_emb
