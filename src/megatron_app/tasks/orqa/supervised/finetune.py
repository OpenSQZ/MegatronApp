...
from megatron_app.tasks.finetune_utils import finetune
from megatron_app.tasks.orqa.supervised.eval_utils import accuracy_func_provider
from megatron_app.tasks.orqa.supervised.eval_utils import process_batch, task_collate_fn
from megatron_app.tasks.orqa.evaluate_utils import ORQAEvaluator
...
def main():
    ...
    if args.task == 'RET-FINETUNE-NQ':
        from megatron_app.tasks.orqa.supervised.data import NQSupervisedDataset as Dataset
    else:
