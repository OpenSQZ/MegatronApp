...
from megatron_app.tasks.eval_utils import accuracy_func_provider
...
def main():
    ...
    if args.task == 'MNLI':
        ...
        num_classes = 3
        from megatron_app.tasks.glue.mnli import MNLIDataset as Dataset
        ...
        num_classes = 2
        from megatron_app.tasks.glue.qqp import QQPDataset as Dataset
