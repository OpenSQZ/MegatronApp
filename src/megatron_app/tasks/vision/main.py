...
if __name__ == "__main__":
    ...
    if args.task == 'classify':
        from megatron_app.tasks.vision.classification.classification import main
        main()
    elif args.task == 'segment_setr':
        from megatron_app.tasks.vision.segmentation.finetune_setr import main
        main()
    elif args.task == 'segment_segformer':
        from megatron_app.tasks.vision.segmentation.finetune_segformer import main
        main()
