...
To review more advanced examples, explore [`scripts/training/pretrain_gpt.py`](../../scripts/training/pretrain_gpt.py). ``pretrain_gpt.py`` has more complex training loops and includes the following Megatron Core features:
